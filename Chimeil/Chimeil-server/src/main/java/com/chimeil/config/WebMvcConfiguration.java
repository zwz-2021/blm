package com.chimeil.config;

import com.chimeil.interceptor.JwtTokenAdminInterceptor;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    public Docket docket1() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2) //创建对象
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.chimeil.controller"))//生成接口文档扫描的包
    ...
    protected void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
       ...
       //为消息转换器设置一个对象转换器，把java对象序列化为json数据
